...
namespace Order.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251001140246_addActivationToSupplier")]
    partial class addActivationToSupplier
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Order.Domain.Models.DeliveryStation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Order.Domain.Models.Otp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Order.Domain.Models.SupplierDeliveryStation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SupplierDeliveryStations");
                });
            ...
            modelBuilder.Entity("Order.Domain.Models.SupplierRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Order.Domain.Models.SupplierDeliveryStation", b =>
                {
                    b.HasOne("Order.Domain.Models.DeliveryStation", "DeliveryStation")
                        .WithMany("SupplierDeliveryStations")
                        .HasForeignKey("DeliveryStationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Order.Domain.Models.DeliveryStation", b =>
                {
                    b.Navigation("SupplierDeliveryStations");
                });
